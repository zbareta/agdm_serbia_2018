...
<html lang="en">
	...
	<body style="font-family:arial; font-size: 13; width:95%; margin:20 auto;" onload="myFunction()">
			...
			<table id="data" class="display" cellspacing="0" width="2800px" style="font-family:arial; font-size: 13">
				...
				<?php
					...
					<tr style="font-size: 11">
						...
						<td style="width: 200px"><?php if(isset($item['date_of_visit'])){echo strtoupper($item['date_of_visit']);}else echo "No Data";?></td>
						<td ><?php if (isset($item['group_lx5pn98'])){foreach($item['group_lx5pn98'] as $it)
							{
								echo $it['group_lx5pn98/Interpreter_name'] . " (" . strtoupper($it['group_lx5pn98/Translator_Interpreter_Organiz']) . ")" . ";<br>";}}else echo "No Data";?>
						</td>
						<td ><?php if (isset($item['group_lx5pn98'])){foreach($item['group_lx5pn98'] as $it)
							{
								echo $it['group_lx5pn98/Evaluation'] . ";<br>";}}else echo "No Data";?>
						</td>
						<td ><?php if (isset($item['group_lx5pn98'])){foreach($item['group_lx5pn98'] as $it)
							{
								if (isset($it['group_lx5pn98/Quality'])){echo str_replace("1", "1 - Very Dissatisfied", str_replace("2", "2 - Somewhat Dissatisfied", str_replace("3", "3 - Neither Satisfied Nor Dissatisfied", str_replace("4", "4 - Somewhat Satisfied", str_replace("5", "5 - Very Satisfied", $it['group_lx5pn98/Quality']))))) . ";<br>";} else echo "No data";}} else echo "No Data";?>
						</td>
						...
						<td><?php if (isset($item['protection_risk'])){foreach($item['protection_risk'] as $it)
							{
								if(isset($it['protection_risk/Follow_up_Done'])){echo strtoupper($it['protection_risk/Follow_up_Done']) . ";<br>";}else echo "No Data" . "<br>";}}else echo "No Data";?>
						</td>
						<td style="width: 300px"><?php if (isset($item['protection_risk'])){foreach($item['protection_risk'] as $it)
							{
								if(isset($it['protection_risk/Follow_up_Details'])){echo strtoupper($it['protection_risk/Follow_up_Details']) . ";<br>";}else echo "No Data" . "<br>";}}else echo "No Data";?>
						</td>
